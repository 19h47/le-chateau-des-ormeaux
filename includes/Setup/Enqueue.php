	...
	public function enqueue_scripts(): void {
		...
		$data = array(
			...
			'messages'               => array(
				...
				'type_mismatch' => array(
					'email'   => _x( 'Please enter an email address.', 'messages', 'le-chateau-des-ormeaux' ),
					'url'     => _x( 'Please enter a URL.', 'messages', 'le-chateau-des-ormeaux' ),
					'default' => _x( 'Please match the expected format.', 'messages', 'le-chateau-des-ormeaux' ),
				),
			),
		);
