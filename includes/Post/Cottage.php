...
class Cottage {
	...
	public function register(): void {
		$labels = array(
			...
			'not_found'                => __( 'No case studies found.', 'le-chateau-des-ormeaux' ),
			'not_found_in_trash'       => __( 'No case studies found in Trash.', 'le-chateau-des-ormeaux' ),
			'parent_item_colon'        => __( 'Parent Cottage:', 'le-chateau-des-ormeaux' ),
			'all_items'                => __( 'All Case Studies', 'le-chateau-des-ormeaux' ),
